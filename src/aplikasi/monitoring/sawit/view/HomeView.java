...
public class HomeView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pendapatan = new javax.swing.JMenuItem();
    ...
    private void pendapatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pendapatanActionPerformed
        // TODO add your handling code here:
         try {
            LaporanPendapatanView pendapatan = new LaporanPendapatanView();
            pendapatan.setVisible(true);
            pendapatan.revalidate();
        } catch (Exception e) {
    ...
    private void pengeluaranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pengeluaranActionPerformed
        // TODO add your handling code here:
         try {
            LaporanPengeluaranView pengeluaran = new LaporanPengeluaranView();
            pengeluaran.setVisible(true);
            pengeluaran.revalidate();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error : "+e);
        }
...
//    }
    ...
    private javax.swing.JMenuItem pendapatan;
