...
public class KebunCariController {
    ...
    private static String className = "KebunCariController";
     ...
     public void setTableModel(KebunCariView kebunCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(kebunCariView, "Terjadi kesalahan pada class " + className + ", methode setTableModel");
        }
    }
   public void loadData(KebunCariView kebunCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(kebunCariView, "Terjadi kesalahan pada class " + className + ", methode loadData");
        }
    }
    ...
    public void searchData(KebunCariView kebunCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(kebunCariView, "Terjadi kesalahan pada class " + className + ", methode searchData");
        }
    }
      ...
      public void refresh(KebunCariView kebunCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(kebunCariView, "Terjadi kesalahan pada class" + className + ", methode refresh");
