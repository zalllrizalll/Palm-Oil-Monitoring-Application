...
public class CustomerCariController {
     ...
     public void setTableModel(CustomerCariView customerCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(customerCariView, "Terjadi kesalahan pada class " + className + ", methode setTableModel");
        }
    }
   public void loadData(CustomerCariView customerCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(customerCariView, "Terjadi kesalahan pada class " + className + ", methode loadData");
        }
    }
    ...
    public void searchData(CustomerCariView customerCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(customerCariView, "Terjadi kesalahan pada class " + className + ", methode searchData");
        }
    }
      ...
      public void refresh(CustomerCariView customerCariView) {
        try {
            ...
            JOptionPane.showMessageDialog(customerCariView, "Terjadi kesalahan pada class" + className + ", methode refresh");
